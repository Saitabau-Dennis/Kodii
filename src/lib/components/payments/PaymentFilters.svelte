...
<div class="flex flex-col gap-4">
  ...
  <div class="relative w-full md:max-w-md">
    <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
      <SearchOutline class="h-3.5 w-3.5 text-gray-500 dark:text-gray-400" />
    </div>
    <input
      type="text"
      value={searchQuery}
      ...
      class="h-9 w-full rounded-md border border-gray-200 bg-gray-100 py-1.5 pl-9 pr-3 text-sm text-gray-700 placeholder-gray-500 focus:border-primary-600 focus:ring-primary-600 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:placeholder-gray-400"
    />
  </div>
</div>
